...
public class VistaGrafica extends JFrame implements Vista{
	...
	private JMenuBar creaMenu(){
		...
		nuevo.addActionListener(new OyenteAutomata(this));
		...
		nuevo2.addActionListener(new OyenteAutomataPila(this)); //XXX
		...
		nuevo3.addActionListener(new OyenteAutomataTuring(this)); 
		...
		nuevaER.addActionListener(new OyenteExpr(this));
	...
	private JPanel creaPanelNorte(){
		...
		nuevoAutomata.addActionListener(new OyenteAutomata(this));
	...
	public void trataMensaje(String mensaje) {
		// TODO Auto-generated method stub
		if (mensaje.toUpperCase().equals("AF"))
			this.setOpcionesAF();
		if (mensaje.toUpperCase().equals("MT"))
			this.setOpcionesMT();
		if (mensaje.toUpperCase().equals("AP"))
			this.setOpcionesAP();
	...
	public class OyenteAutomataGeneral implements ActionListener{
		...
		public void actionPerformed(ActionEvent e){
			...
			panelCentral.getPanel().borrarPanel();
			panelCentral.desactivarEjercicio(); //a�adido
			activaToogleButtons();
			rutaVista=null;
	...
	public class OyenteAutomata extends OyenteAutomataGeneral implements ActionListener{
		...
		VistaGrafica _vista;
		OyenteAutomata (VistaGrafica vista){
			_vista=vista;
		}
		public void actionPerformed(ActionEvent e){
	...
	public class OyenteAutomataPila extends OyenteAutomataGeneral implements ActionListener{
		...
		VistaGrafica _vista;
		OyenteAutomataPila(VistaGrafica vista)
		{
			_vista= vista;
	...
	public class OyenteAutomataTuring extends OyenteAutomataGeneral implements ActionListener{
		...
		VistaGrafica _vista;
		OyenteAutomataTuring(VistaGrafica vista)
		{
//			_vista=vista;
		}
		public void actionPerformed(ActionEvent e){
	...
	public class OyenteExpr implements ActionListener{
		VistaGrafica _vista;
		public OyenteExpr(VistaGrafica vista)
		{
			_vista=vista;
		}
		public void actionPerformed(ActionEvent e){
	...
	public static void setBotonLatex(boolean b){
			botonLatex.setEnabled(b);
		}
	public static void setEstaPalabra(boolean b){
			estaPalabra.setEnabled(b);
			}
	public static void setBotonTuring(boolean b){
		
			botonTuring.setEnabled(b);
		}
}
